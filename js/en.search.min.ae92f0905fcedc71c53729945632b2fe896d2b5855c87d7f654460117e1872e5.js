...
function init(){input.removeEventListener('focus',init);loadScript('/medusa-docs/js/groupBy-174feb11c7.min.js');loadScript('/medusa-docs/js/flexsearch-e54a90f706.min.js',function(){const indexCfgDefaults={tokenize:'forward'}
const indexCfg=indexCfgDefaults;const dataUrl='/medusa-docs/en.search-data.min.json'
